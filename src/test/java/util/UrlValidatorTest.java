...
public class UrlValidatorTest {
  ...
  void validate_rejectsNonHttpScheme() {
    IllegalArgumentException ex =
        assertThrows(
            IllegalArgumentException.class, () -> UrlValidator.validate("ftp://example.com"));
  ...
  void validate_rejectsUrlWithoutHost() {
    IllegalArgumentException ex =
        assertThrows(IllegalArgumentException.class, () -> UrlValidator.validate("https:///path"));
    assertTrue(
        ex.getMessage().toLowerCase().contains("домен")
